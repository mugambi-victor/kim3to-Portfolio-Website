...
<body style="background-color:#000; color:white">
    <nav class="navbar navbar-expand-lg fixed-top custom-nav sticky" style="background-color:#000;">
        <div class="container">
            ...
            <button class="navbar-toggler " style="color: #fff;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (isset($_SESSION['admin_id'])): ?>
                        <li class="nav-item">
                            <a href="/create_post.php" class="nav-link">New Post</a>
                        </li>
                    <?php endif; ?>
                    <?php if (isset($_SESSION['admin_id'])): ?>
                        <li class="nav-item">
